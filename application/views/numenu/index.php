...
<!-- End Google Tag Manager --> 
  ...
  <link rel="shortcut icon" href="<?php echo base_url('assets/img/numenu/favicon.png') ?>">
  <!-- Bootstrap core CSS -->
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/numenu_styles.css') ?>?v=<?php echo filemtime('assets/css/numenu_styles.css') ?>">
    ...
    $(document).ready(function() {
      animateCSS('.logoImg', 'bounceInDown', function() {
        ...
        animateCSS('.logoNumenuName', 'bounceInUp', function() {
          setTimeout(function() {
            location.href = '<?php echo base_url('numenu/agenda'); ?>';
          }, 500);
        });
      });
    });
    ...
    <div class="numenu_welcome_page">
      <div class="container">
        ...
        <div class="logoNumenuName">
          <img src="<?php echo base_url('assets/img/numenu/logo_branco_numenu.png'); ?>" alt="Numenu" class="img-fluid" />
        </div>
      </div>
    </div>
