...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="fullpage agenda">
        <?php $this->load->view('volanty/nav_agenda', array("logado" => (isset($_SESSION['logado']) ? $_SESSION['logado'] : 0), "agenda" => 1)); ?>
        <div id="loader" style="display: none;">
            <div class="loader"></div>
        </div>
        <div class="section" style="background-color: #fff;">
            <!-- PASSO 01 -->
            <?php $this->load->view('volanty/passo-1'); ?>

            <!-- SOB CONSULTA -->
            <?php $this->load->view('volanty/passo-consulta'); ?>

            <!-- PASSO 02 -->
            <?php $this->load->view('volanty/passo-2'); ?>

            <!-- PASSO 03 -->
            <?php $this->load->view('volanty/passo-3'); ?>

            <!-- PASSO 04 -->
            <?php $this->load->view('volanty/passo-4'); ?>

            <!-- PASSO 05 -->
            <?php $this->load->view('volanty/passo-5'); ?>

            <!-- PASSO 06 -->
            <?php $this->load->view('volanty/passo-6'); ?>
        </div>
    </div>
...
<?php $this->load->view('volanty/login-modal'); ?>
