...
<nav class="navbar navbar-expand-lg navbar-light menu-superior">
  ...
  <div class="collapse navbar-collapse " id="navbarSupportedContent">
    <ul class="navbar-nav top-nav">
      <li class="nav-item">
        <a class="nav-link" href="<?= isset($outfromindex) ? base_url() : null ?>#servicos"> Como Funciona</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-toggle="modal" data-target="#ajudaModal" href="#"> Central de Ajuda </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= isset($outfromindex) ? base_url() : null ?>#contato"> Contato</a>
      </li>
    </ul>
