...
<body class="bg-light">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <?php $this->load->view('nav_admin', array("tipo" => "usuarios")); ?>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2 mx-auto">Usuários</h1>

        </div>

        <div class="table-responsive">
          <?php $url = base_url("admin/exportUsuarios") ?>
          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              <?php foreach ($lista_usuarios as $usuario) { ?>
                <tr>
                  <td><?php echo $usuario["cod_login"]; ?></td>
                  <td><?php echo $usuario["nome"]; ?></td>
                  <td><?php echo $usuario["email"]; ?></td>
                  <td><?php echo $usuario["telefone_contato"]; ?></td>
          ...
          <div aria-label="Page navigation example">
            <ul class="pagination justify-content-center col-md-10">
              <?php for ($x = 0; $x < (int) ceil($count / 10); $x++) : ?>
                <li class="page-item <?php echo $x == $offset ? "active" : "" ?>"><a class="page-link" href="<?php echo base_url("admin/usuarios/$x"); ?>"><?php echo $x + 1; ?></a></li>
              <?php endfor; ?>
            </ul>
          </div>
        </div>
