<style media="screen">
    ...
    /* .logo{
        background-image: url(<?php echo base_url("assets/img/volanty/horizontal_logos.png") ?>);
...
<nav class="navbar navbar-expand-lgt menu-superior">
    <a id="logo-servicos" class="navbar-brand right">
        <img class="img-fluid" style="width: 200px; margin-top: -10px;" src="<?php echo base_url('assets/img/volanty/horizontal_logos.png') ?>" onclick="$('#confirmModal').modal('toggle')">
    </a>
