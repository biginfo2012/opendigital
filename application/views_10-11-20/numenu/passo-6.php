        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-12 text-center">
            <div class="center">
              ...
              <br /><br />
              <div>
                <button onclick="FinalizaNumenu(); return false;" type="submit" class="btn btn-enviar"> <span>Finalizar</span> &nbsp;&nbsp;<i class="fas fa-angle-right"></i></button>
              </div>
            </div>
          </div>
        </div> <!-- /CONFIRMAÇÃO -->
